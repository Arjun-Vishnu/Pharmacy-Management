        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-8 offset-2">
                    <Link to="/medicine/list/create" className="btn btn-info mb-2">Create Medicine</Link>
                    <Link to="/medicine/list/search" className="btn btn-info mb-2 ml-4">Search Medicine</Link>
